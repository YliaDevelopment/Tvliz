...
public class TvlizServerListener implements RakNetServerListener {
  ...
  public void handlePing(ServerPing ping) {
    ping.setIdentifier(new MinecraftIdentifier("Proxy Server", 84, "0.15.10", server.getSessionCount(),
        server.getMaxConnections(), server.getGloballyUniqueId(), "Proxy World", "Survival"));
  }
}
